...
// setInterval(function Volts(){
//   var xhr = new XMLHttpRequest();
//   xhr.onreadystatechange = function() {
//     if (this.readyState == 4 && this.status == 200) {
//       var obj = JSON.parse(this.responseText);
//       //console.log(obj);      
//       chart2.series[2].setData(obj.volts);
//     }
//   };
...
setInterval(function AmpsInHistory(){
  var xhr = new XMLHttpRequest();
  xhr.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      var obj = JSON.parse(this.responseText);
      //console.log(obj);
      chart3.series[0].setData(obj.amphrin);
    }
  };
  xhr.open("GET", "/graphdataAhIn", true);
  xhr.send();
}, 5000 ) ;


setInterval(function AmpsOutHistory(){
  var xhr = new XMLHttpRequest();
  xhr.onreadystatechange = function() {
    if (this.readyState == 4 && this.status == 200) {
      var obj = JSON.parse(this.responseText);
      //console.log(obj);
      chart3.series[1].setData(obj.amphrout);
    }
  };
  xhr.open("GET", "/graphdataAhOut", true);
  xhr.send();
}, 5000 ) ;
...
//     var myObj = JSON.parse(e.datArchive/test_archive.ha);
//     console.log(myObj);
